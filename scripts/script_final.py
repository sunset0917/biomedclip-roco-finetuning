...
# BiomedCLIP usa PubMedBERT como text encoder
for param in model.text.transformer.encoder.layer[-2:].parameters():
    param.requires_grad = True
...
for epoch in range(epochs):
    ...
    if current_recall > best_recall:
        ...
        no_improve  = 0
        torch.save(model.state_dict(), "biomedclip_best_mas.pt")
